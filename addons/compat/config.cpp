...
class CfgVehicles {
    ...
    // --- UKSF Toyota Technicals (Reinforced Base) ---
    ...
    class UKSF_Toyota_HZJ79: Arlit_TOYOTA_LC_HZJ79 {
        ...
        armor = 360;          // Tripled from 120
        armorStructural = 8;  // Doubled from 4
        
        class HitPoints {
            class HitGlass1 { armor = 0.1; minimalHit = 0.05; passThrough = 0; };
            ...
            class HitBody { armor = 6; minimalHit = 0.15; passThrough = 0.1; };
            class HitEngine { armor = 3; minimalHit = 0.15; passThrough = 0.1; }; 
            class HitFuel { armor = 3; minimalHit = 0.15; passThrough = 0.1; };
        };
    };
    ...
    // --- UKSF Land Cruiser (Armoured Base) ---
    ...
    class UKSF_LC200_VX_16: arlit_200_VX_16 {
        ...
        class HitPoints {
            class HitGlass1 { armor = 1.0; minimalHit = 0.1; passThrough = 0; };
            class HitGlass2: HitGlass1 {};
            class HitGlass3: HitGlass1 {};
            class HitGlass4: HitGlass1 {};
            class HitGlass5: HitGlass1 {};
            ...
            class HitBody { armor = 4; minimalHit = 0.2; passThrough = 0.1; };
            class HitEngine { armor = 3; minimalHit = 0.35; passThrough = 0.05; }; 
            class HitFuel { armor = 2; minimalHit = 0.35; passThrough = 0.05; };
        };
    };
};
